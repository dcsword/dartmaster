...
export default function Game() {
  ...
  return (
    <div style={{ maxWidth: "480px", margin: "0 auto", display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      {/* Dart slots */}
      <div style={{ padding: "4px 16px", display: "flex", gap: "5px", flexShrink: 0 }}>
        {[0, 1, 2].map(i => (
      ...
      {/* Input area */}
      <div style={{ padding: "6px 16px", flex: 1, display: "flex", flexDirection: "column", gap: "5px" }}>
        ...
        {/* Action row */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "6px", paddingBottom: "12px" }}>
